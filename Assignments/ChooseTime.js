...
import Calendar from './util/Calendar/CalendarTime';
                ...
                <div className="meetingdetailcontain float-left makeclassroom makeassignment3">
                    ...
                    <div className="meetingdetailsmiddle makeclassroommiddle">
                        <div className="section _3dchild">
                            <div className="pagecontain widthcalendar2">
                    ...
                    <div className="bottommorelink bottommoreright makeclassroombottom secondclassroom2">
